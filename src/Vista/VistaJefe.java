...
public class VistaJefe extends javax.swing.JFrame implements Observer {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No. Solicitud", "Fecha", "Tipo de Adquisicion", "Funcionario", "Dependencia", "Registrador"
            }
        ));
        ...
        jMenuItem3.setText("Recursos Humanos");
        jMenu1.add(jMenuItem3);

        jMenuItem4.setText("Registrador");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaJefe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
